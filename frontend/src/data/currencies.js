...
export const CURRENCIES = [
  ...
  { code: "OMR", name: "Omani Rial",                  symbol: "OM"  },
  ...
  { code: "TND", name: "Tunisian Dinar",              symbol: "TD"  },
...
/** Most commonly used currencies — shown first in dropdowns */
export const COMMON_CURRENCIES = ["USD","EUR","GBP","CAD","CHF","MAD","AED","SAR","QAR","KWD","EGP","TND","DZD","XOF","XAF","NGN","ZAR","INR","JPY","CNY","AUD","BRL","MXN","SGD","HKD"];

/** Get currency object by code */
export const getCurrency = (code) => CURRENCIES.find(c => c.code === code);

/** Label for dropdown: "USD — US Dollar ($)" */
export const currencyLabel = (c) => `${c.code} — ${c.name} (${c.symbol})`;
