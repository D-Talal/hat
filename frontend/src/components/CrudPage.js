...
const STRING_FIELDS = ['unit_number', 'room_number', 'phone', 'id_number', 'amenities', 'description', 'reported_by', 'contact_name', 'business_name', 'unit_type', 'room_type', 'bed_type', 'nationality', 'special_requests', 'email', 'address', 'name', 'title'];
