...
export default function Contracts() {
  ...
  return (
    <div className="animate-fade">
      ...
      {modal === 'new' && <CommercialModal title="New Contract" onClose={() => setModal(null)} wide><ContractForm onSave={load} onClose={() => setModal(null)} /></CommercialModal>}
      {selected && <CommercialModal title={`Contract ${selected.contract_number || `#${selected.id}`}`} onClose={() => setSelected(null)}><ContractDetail contract={selected} onClose={() => setSelected(null)} onRelease={release} /></CommercialModal>}
    </div>
  );
}
