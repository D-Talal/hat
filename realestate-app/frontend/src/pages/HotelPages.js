...
export function HotelList() {
  return <CrudPage title="Hotels" sub="Manage your hotel properties" api={hotel.hotels}
...
const RoomForm = ({ form, setForm }) => {
  ...
  return <>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
      ...
      <Input label="Capacity" type="number" value={form.capacity || ''} onChange={s('capacity')} />
    </div>
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
      <Input label="Base Rate ($/night)" type="number" value={form.base_rate || ''} onChange={s('base_rate')} />
...
export function HotelRooms() {
  return <CrudPage title="Rooms" sub="Manage room inventory and availability" api={hotel.rooms}
...
export function HotelGuests() {
  return <CrudPage title="Guests" sub="Manage guest profiles and history" api={hotel.guests}
    ...
    columns={[
      ...
      { key: 'created_at', label: 'Since', render: v => v ? new Date(v).toLocaleDateString() : '—' },
    ]}
...
export function HotelBookings() {
  return <CrudPage title="Bookings" sub="Manage reservations and check-in/out" api={hotel.bookings}
