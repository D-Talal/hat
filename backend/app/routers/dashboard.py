...
from app.models.retail import Property, Unit, UnitStatus, Tenant, Invoice, MaintenanceRequest
...
def get_cashflow(
    ...
    # ── No cost field on MaintenanceRequest — outflow stays 0 for now ──
